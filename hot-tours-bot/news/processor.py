...
— Темы вне туризма (общественные события, не связанные с отдыхом). Допустимо: новости о туристической безопасности на курорте (например, природные явления, повлиявшие на отдых)
