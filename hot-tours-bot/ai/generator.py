...
3. ОПИСАНИЕ — РОВНО ОДНО предложение, не более 20 слов. После него — пустая строка и сразу ✅✅. БЕЗ второго абзаца. БЕЗ продолжений.
   ...
   — ЗАПРЕЩЁННЫЕ СЛОВА: роскошный, роскошь, великолепный, незабываемый, комфортный, уютный, прекрасный, удивительный, волшебный, сказочный, отдых мечты, райский, рай, дивный, восхитительный, чарующий, прелестный, очаровательный.
   — ЗАПРЕЩЁННЫЕ ФРАЗЫ: «вас ждёт», «вы погрузитесь», «насладитесь», «массу впечатлений», «подарит ... атмосферу», «впечатления благодаря», «приятное дополнение», «расслабьтесь», «откройте для себя», «всё для вашего отдыха», «душой и телом», «5-звёздочного отдыха».
