...
3. 2-3 КОНКРЕТНЫХ факта об отеле/направлении ОДНИМ коротким предложением (не абзацем).
   — Если есть «Особенности отеля» — выбери 2-3 самых сильных и слепи в одно предложение.
   — Если нет — короткая фраза про сезон/курорт ({resort or country}) с привязкой к датам ({date}).
   — ЗАПРЕЩЁННЫЕ СЛОВА (вода): «роскошный», «великолепный», «незабываемый», «комфортный», «уютный», «прекрасный», «удивительный», «волшебный», «сказочный», «отдых мечты».
   — НЕ пиши «вы погрузитесь в атмосферу», «насладитесь», «получите массу впечатлений» — это пустые фразы.
