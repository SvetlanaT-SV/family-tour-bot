...
Стиль: живой, дружелюбный, как советует подруга. Без воды. Используй только HTML-теги <b> для жирного."""
    ...
    desc_default_pool = [
        ...
        f"{place} — бюджетно и без лишних хлопот. Отель в шаговой доступности от моря, с приветливым персоналом и простой, но вкусной кухней. Для тех, кто ценит время на пляже больше интерьеров.",
